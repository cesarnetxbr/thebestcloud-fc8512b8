  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "list", items: [
        ...
        "quotes + quote_items (numeração automática ORC-AAAA-NNNNN; CRUD completo: criar, visualizar, editar, duplicar e excluir; status configurável Rascunho/Enviado/Aceito/Assinado; versionamento via parent_quote_id + version; itens avulsos permitidos via campo livre com sugestões da tabela de venda; reordenação de itens via setas ↑/↓ no editor; impressão/PDF multi-página validada em Chrome e Firefox; logo ampliada (h-24) no preview; reajuste anual indexado pelo IPCA; campos novos: general_notes (observações gerais no rodapé), policy_text (termos de confidencialidade e responsabilidade), client_acceptance_name/document/date e client_signature_data_url (assinatura manuscrita em base64 PNG/JPG até 2 MB, exibida em quadro de aceite)",
