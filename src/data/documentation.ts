  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "list", items: [
        ...
        "quotes + quote_items (numeração automática ORC-AAAA-NNNNN; CRUD completo: criar, visualizar, editar, duplicar e excluir; status configurável Rascunho/Enviado/Aceito/Assinado; versionamento via parent_quote_id + version; itens avulsos permitidos via campo livre com sugestões da tabela de venda; reordenação de itens via setas ↑/↓ no editor; impressão/PDF multi-página validada em Chrome e Firefox — o botão Imprimir/PDF clona o #quote-preview para um contêiner dedicado #tbc-print-root fora do Dialog do Radix, contornando os limites de altura/overflow que truncavam o resultado em 1 página; cabeçalho da tabela repetido a cada página via thead display:table-header-group)",
